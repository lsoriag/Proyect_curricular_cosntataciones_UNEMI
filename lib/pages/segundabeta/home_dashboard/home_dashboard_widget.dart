  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<int>(
      ...
      builder: (context, snapshot) {
        ...
        int homeDashboardCount = snapshot.data!;
                                        ...
                                        if (responsiveVisibility(
                                          ...
                                          Padding(
                                            ...
                                            child: LinearPercentIndicator(
                                              ...
                                              animation: true,
                                              animateFromLastPercent: true,
                                              progressColor: Color(0xFFFFAA46),
                                              backgroundColor:
                                                  FlutterFlowTheme.of(context)
                                                      .accent1,
                                              barRadius: Radius.circular(24.0),
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(0.0, 4.0,
                                                                0.0, 0.0),
                                                    child: Text(
                                                      'Numero de activos por constatar.',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .labelMedium,
                      ...
                      child: StreamBuilder<List<ConstataciondeactivosRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<ConstataciondeactivosRecord>
                              mainCardConstataciondeactivosRecordList =
                              snapshot.data!;
                          // Return an empty Container when the item does not exist.
                          if (snapshot.data!.isEmpty) {
                            return Container();
                          }
                          final mainCardConstataciondeactivosRecord =
                              mainCardConstataciondeactivosRecordList.isNotEmpty
                                  ? mainCardConstataciondeactivosRecordList
                                      .first
                                  : null;
                          return Container(
