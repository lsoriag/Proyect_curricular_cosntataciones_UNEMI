...
import 'home_list2_model.dart';
export 'home_list2_model.dart';

class HomeList2Widget extends StatefulWidget {
  const HomeList2Widget({Key? key}) : super(key: key);

  @override
  _HomeList2WidgetState createState() => _HomeList2WidgetState();
}

class _HomeList2WidgetState extends State<HomeList2Widget> {
  late HomeList2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeList2Model());
    ...
    return StreamBuilder<List<ConstataciondeactivosRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ConstataciondeactivosRecord>
            homeList2ConstataciondeactivosRecordList = snapshot.data!;
                                ...
                                () async {
                                  safeSetState(() {
                                    _model.simpleSearchResults = TextSearch(
                                      homeList2ConstataciondeactivosRecordList
                                          .map(
                                            (record) =>
