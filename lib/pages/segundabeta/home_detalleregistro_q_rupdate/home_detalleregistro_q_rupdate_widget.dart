...
import 'home_detalleregistro_q_rupdate_model.dart';
export 'home_detalleregistro_q_rupdate_model.dart';

class HomeDetalleregistroQRupdateWidget extends StatefulWidget {
  const HomeDetalleregistroQRupdateWidget({
    Key? key,
    required this.idproductotwo2,
  }) : super(key: key);

  final DocumentReference? idproductotwo2;

  @override
  _HomeDetalleregistroQRupdateWidgetState createState() =>
      _HomeDetalleregistroQRupdateWidgetState();
}

class _HomeDetalleregistroQRupdateWidgetState
    extends State<HomeDetalleregistroQRupdateWidget> {
  late HomeDetalleregistroQRupdateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeDetalleregistroQRupdateModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<ConstataciondeactivosRecord>(
      stream: ConstataciondeactivosRecord.getDocument(widget.idproductotwo2!),
      builder: (context, snapshot) {
        ...
        final homeDetalleregistroQRupdateConstataciondeactivosRecord =
            snapshot.data!;
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ClipRRect(
                                      ...
                                      child: Image.network(
                                        homeDetalleregistroQRupdateConstataciondeactivosRecord
                                            .photosUrl,
                                        width: 300.0,
                                        height: 200.0,
                                        fit: BoxFit.cover,
                                            ...
                                            children: [
                                              ...
                                              FFButtonWidget(
                                                onPressed: () async {
                                                  ...
                                                  await homeDetalleregistroQRupdateConstataciondeactivosRecord
                                                      .reference
                                                      .update(
