...
class NewdocumentWidget extends StatefulWidget {
  const NewdocumentWidget({Key? key}) : super(key: key);

  @override
  _NewdocumentWidgetState createState() => _NewdocumentWidgetState();
}
    ...
    return StreamBuilder<List<ConstataciondeactivosRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ConstataciondeactivosRecord>
            newdocumentConstataciondeactivosRecordList = snapshot.data!;
                                ...
                                () async {
                                  safeSetState(() {
                                    _model.simpleSearchResults = TextSearch(
                                      newdocumentConstataciondeactivosRecordList
                                          .map(
                                            (record) =>
